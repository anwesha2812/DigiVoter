...
<div class="content">
  ...
  <div class="cards">
    ...
    <div class="card">
      ...
      <img src="JSS.png" alt="">
      <p class="card-desc">They work under Sports Secretary and create zeal amongst students and faculty members towards sports.<br>They look after proper maintenance of sports accessories and arranging the venues for sports events.</p>
    </div>
    <div class="card">
    ...
    <div class="card">
      <h2 class="card-title">Joint Ladies Reprentative</h2>
      <img src="JLR.png" alt="">
