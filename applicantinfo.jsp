<%-- 
    Document   : applicantinfo
    Created on : 15-Mar-2022, 10:34:40 pm
    Author     : HP
--%>
...
<html>
    ...
    <body>
          <%!int count, num;
            String moodle, fname, mname, lname, branch, post, year, age, q1, q2, q3, q4, q5, imgFileName, cvFileName;%>
    ...
    <div class="ellipse">
        ...
        <form action="AcceptServlet">
            <input hidden value="<%=moodle%>">
